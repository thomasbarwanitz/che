...
public class GdbTest {
    ...
    private String endlessLoopFile;
    private Path   endlessLoopSourceDirectory;
//    private String file;
//    private Path   sourceDirectory;
    ...
    public void beforeClass() throws Exception {
        endlessLoopFile = GdbTest.class.getResource("/a.out").getFile();
        endlessLoopSourceDirectory = Paths.get(GdbTest.class.getResource("/endlessLoop.cpp").getFile());
...
//        gdb.directory(endlessLoopSourceDirectory.getParent().toString());
    }
...
//        assertNull(gdbInfoProgram.getStoppedAddress());
    ...
    public void testSuspend() throws Exception {
        gdb = Gdb.start();
        gdb.directory(endlessLoopSourceDirectory.getParent().toString());
        gdb.file(endlessLoopFile);
//        new Thread() {
//            public void run() {
//                try {
//                    Thread.sleep(10000);
//
//                    Location location = gdb.suspend();
//
//                    assertNotNull(location);
//                    assertEquals(location.getLineNumber(), 7);
